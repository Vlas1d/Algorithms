...
let arr3 = arr2.slice(2, 9);
console.log(`>>> Part: ${arr3}`);
arr3.reverse();
console.log(`>>> Reverse array: ${arr3}`);
arr3.push(31);
console.log(`>>> New array: ${arr3}`);
let a = arr3.indexOf(31);
let b = arr3.indexOf(3432);
let c = arr3.lastIndexOf(31);
let d = arr3.includes(44);
...
let arr4 = arr3.filter((element) => element % 2 === 0);
